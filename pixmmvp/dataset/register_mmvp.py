...
_PREDEFINED_SPLITS_MMVP = {
    ...
    "mmvp_sensitivity_val": (
        "MMVP_Prompts_Sensitivity/var_{:02d}/MMVP Images/",
        "MMVP_Prompts_Sensitivity/Segmentations_{:02d}.json",
    ),
}
...
def register_new_dataset(root, current_variation=-1):
    ...
    for (
        ...
        if 'sensitivity' in prefix and current_variation != -1:
            predef_root = predef_root.format(current_variation)
            predef_json = predef_json.format(current_variation)
